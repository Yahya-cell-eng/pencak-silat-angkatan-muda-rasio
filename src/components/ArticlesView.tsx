                  ...
                  <div className="pt-3 border-t border-slate-100 flex items-center justify-between text-xs">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="p-1 rounded-md hover:bg-slate-100 text-slate-400 hover:text-red-700 transition-colors"
          ...
          <div className="relative w-full max-w-3xl bg-white border border-slate-200 rounded-2xl shadow-2xl overflow-hidden text-slate-800 my-8">
            ...
            <div className="sticky top-0 z-20 flex items-center justify-between px-6 py-3.5 bg-white border-b border-slate-200">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-2.5 py-1.5 rounded-lg bg-red-50 hover:bg-red-100 text-red-700 text-xs font-bold flex items-center gap-1.5 transition-colors cursor-pointer"
                  title="Bagikan ke WhatsApp, Instagram, TikTok"
                >
                  <Share2 className="w-3.5 h-3.5" />
                  <span>Bagikan</span>
              ...
              <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                  ...
                  <a
                    ...
                    className="p-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-xs font-bold flex items-center justify-center gap-1.5 transition-colors shadow-xs"
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => setSharingArticle(activeArticle)}
                    className="p-2 bg-gradient-to-r from-amber-500 via-rose-500 to-purple-600 text-white rounded-lg text-xs font-bold flex items-center justify-center gap-1.5 transition-colors shadow-xs cursor-pointer"
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => setSharingArticle(activeArticle)}
                    className="p-2 bg-slate-900 hover:bg-black text-white rounded-lg text-xs font-bold flex items-center justify-center gap-1.5 transition-colors shadow-xs cursor-pointer"
                  >
                    <span className="text-cyan-400 font-bold">♪</span>
                    <span>TikTok (FYP Tags)</span>
                  </button>
                </div>
              </div>
            ...
            <div className="p-4 bg-slate-50 border-t border-slate-200 flex items-center justify-between">
              <button
                type="button"
                onClick={() => setSharingArticle(activeArticle)}
                className="px-3 py-1.5 bg-white border border-slate-200 hover:bg-slate-100 text-slate-700 font-bold rounded-lg text-xs flex items-center gap-1.5 transition-colors cursor-pointer"
              >
                <Share2 className="w-3.5 h-3.5 text-red-700" />
                <span>Buka Menu Bagikan Lengkap</span>
              </button>
